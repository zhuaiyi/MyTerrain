...
{
    public const byte LBCorner = 0; //左下
    public const byte LTCorner = 1; //左上
    public const byte RTCorner = 2; //右上
    public const byte RBCorner = 3; //右下
    public const byte BBorder = 4;  //正下
    public const byte TBorder = 5;  //正上
    public const byte LBorder = 6;  //正左
    public const byte RBorder = 7;  //正右
